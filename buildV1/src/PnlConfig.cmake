...
if (MSVC)
    ...
    set(PNL_LIBRARY ${pnl_rootdir}/lib/libpnl.so)
endif(MSVC)
...
if (PNL_FOUND)
    if (MSVC)
        ...
        set(PNL_INCLUDE_DIRS ${PNL_INCLUDE_DIR} /usr/lib/x86_64-linux-gnu/openmpi/include;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi)
        set(PNL_LIBRARIES ${PNL_LIBRARY} /usr/lib/x86_64-linux-gnu/libblas.so;/usr/lib/x86_64-linux-gnu/liblapack.so;/usr/lib/x86_64-linux-gnu/libblas.so;/usr/lib/x86_64-linux-gnu/openmpi/lib/libmpi.so;m;dl)
    endif(MSVC)
